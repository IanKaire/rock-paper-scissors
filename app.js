...
const combine =  ( resultHandler, operation, ...numbers ) => {
    ...
    for( const num in numbers) {
        ...
        if(operation === 'ADD'){
         sum += validateNumber(numbers[num]);
        }
        else{
         sum -= validateNumber(numbers[num]);
        }
...
combine(showResult.bind(this, 'The result after adding all numbers is: '), 'ADD', 21, 3, 44, 21);
combine(showResult.bind(this, 'The result after subtracting all numbers is: '), 100, 12,22,18);
